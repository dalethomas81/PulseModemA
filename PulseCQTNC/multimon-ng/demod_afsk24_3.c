 ...
 * Xtal used: 6.5536 MHz
 * Ratio: 1.47816
 * Mark frequency: 3252 Hz
 * Space frequency: 1774 Hz
 */

#define FREQ_MARK  3252
#define FREQ_SPACE 1774
...
static void afsk24_3_init(struct demod_state *s)
{
	float f;
	int i;
